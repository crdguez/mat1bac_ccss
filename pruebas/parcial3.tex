...
\begin{questions}
        ...
        \part[1] $$\lim_{x \to 3} \frac{1}{\left(x-3\right)^2}$$  \begin{solution}   $\lim_{x \to 3^-} \frac{1}{\left(x-3\right)^2}=\infty$ y  \\ $\lim_{x \to 3^+} \frac{1}{\left(x-3\right)^2}=+\infty$   \end{solution}
        \end{parts}
