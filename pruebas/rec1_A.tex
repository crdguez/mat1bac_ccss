...
%\noaddpoints % to omit double points count
\begin{parts}
\part[1] \[\dfrac{10\sqrt{3}+10\sqrt{2}}{2\sqrt{3}-\sqrt{2}}\]
\begin{solution}
$3 \sqrt{6} + 8$
\end{solution}
...
\question Resuelve:
        ...
        \begin{parts} \part[1]  $ x\cdot( {x + 5} ) > 2{x^2} $  \begin{solution}  $ \left(0, 5\right) $  \end{solution}
        \end{parts}
        

        \question Discute el tipo de sistema, mediante el método de Gauss, y resuelve si es posible:
