...
\begin{parts}
\part $\left| {x - 4} \right|< 5$ 
\begin{solution}
$\left(-1, 9\right)$ 
\end{solution}
\part $\left| {x +3 } \right|\geqslant 2$
\begin{solution}
...
\question[2] Racionaliza:
%\noaddpoints % to omit double points count
\begin{parts}
\part \[\dfrac{10}{2\sqrt{3}-\sqrt{2}}\]
\begin{solution}
...
% \part \[\frac{4 + \sqrt {6} }{2\sqrt {3 }}\]
% \begin{solution}
% $=\dfrac{4\sqrt{3}+\sqrt{6}\cdot\sqrt{3}}{2\sqrt{3}\sqrt{3}}=\dfrac{4\sqrt{3}+3\sqrt{2}}{6}$
% \end{solution}

\part $$\frac{1+\sqrt{5}}{\sqrt{5}-1}+\frac{1-\sqrt{5}}{\sqrt{5}+1}$$
