...
\question[2] Halla analíticamente el dominio de las siguientes funciones:
    \begin{multicols}{2}
        ...
        \part $f(x)=\sqrt[3]{\dfrac{x + 2}{x - 3}}$  \begin{solution}   $Dom\left(f \right)=\left(-\infty, 3\right) \cup \left(3, \infty\right)$   \end{solution} \part $f(x)=\sqrt {\dfrac{x}{2 x^{2} + 2 x - 12}}$  \begin{solution}   $Dom\left(f \right)=\left(-\infty, -3\right) \cup \left(2, \infty\right)$   \end{solution} 
        % \part $f(x)=\sqrt {x^2-9}$  \begin{solution}   $Dom\left(f \right)=\left(-\infty, -3\right] \cup \left[3, \infty\right)$   \end{solution}
        
        \end{parts}
    \end{multicols}

\question Dada la función: $$f(x)=\dfrac{3 x - 2}{x - 1}$$ Calcula
        \begin{parts} 
...
\question Calcula los siguientes límites:
        ...
        \part[1] $$\lim_{x \to -2}\left(\frac{2 x^{2} + 7 x + 6}{x^{3} + 3 x^{2} + 3 x + 2}\right)$$  \begin{solution}   $- \frac{1}{3}$   \end{solution} \part[1] $$\lim_{x \to -1}\left(\frac{x^{3} + 1}{x^{2} + 2 x + 1}\right)$$  \begin{solution}   No existe el límite   \end{solution} 
