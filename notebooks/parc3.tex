        ...
        \begin{multicols}{1}
        \begin{parts} \part[1] $\begin{cases} x^{2} & \text{for}\: x < 1 \\\frac{3 x}{2} - \frac{1}{2} & \text{otherwise} \end{cases}$  \begin{solution}   \resizebox {0.5\textwidth}{!}{\input{parc3ex31e050.pgf}} \\   \end{solution}
        \end{parts}
        \end{multicols}
